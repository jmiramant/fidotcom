Refinery::Core.configure do |config|
  ...
  # Site name
  config.site_name = "EverFi"

  # This activates Google Analytics tracking within your website. If this
  # config is left blank or set to UA-xxxxxx-x then no remote calls to
  # Google Analytics are made.
  config.google_analytics_page_code = "UA-33444045-1"
  ...
  # config.dragonfly_secret = "6d62767522ce166aa7476cbd21d169b877179081c197fb6a"
  ...
  config.wymeditor_whitelist_tags = {
    'article' => { 'attributes' => {'1' => 'class'}},
    'link' => { 'attributes' => {'1' => 'href', '2' => 'media', '3' => 'rel', '4' => 'type' } },
    'video' => { 'attributes' => {
        '1' => 'autoplay',
        '2' => 'controls',
        '3' => 'width',
  ...
  config.register_javascript "refinery/admin/add_this_wymeditor_monkeypatch.js"
end
